...
describe User do
  it 'é válido quando nome, último nome e email estão presentes' do
    user = User.new(firstname: 'Bruce', lastname: 'Dickinson', email: 'bruce@ironmaiden.com')
  ...
  it 'é inválido caso já exista um e-mail igual' do
    User.create(firstname: 'Steve', lastname: 'Harris', email: 'contato@ironmaiden.com')
    user = User.new(firstname: 'Bruce', lastname: 'Dickinson', email: 'contato@ironmaiden.com')
    user.valid?
